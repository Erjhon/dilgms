...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Code Igniter Version <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
        <h1> PHP version <?php echo phpversion()?>

        <h2>Trying hard Purogamers</h2>
