                ...
                <div class="content-wrapper">
                  ...
                  <h6 class="font-weight-normal mb-0">Here is the updated Memorandum! You have <span class="text-primary">3 unread alerts!</span></h6>
                    ...
                    <div class="card2">
                        ...
                        <div class="lguadmin">
                            <h2>Peace and Order and Related Concerns Section (POARCS)</h2>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">Submission of Functionality Report of B/M/PADAC and
                                                        B/M/PPOC (w/ dates of meeting conducted)</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">Deadline: NLT 5th of the first month after the
                                                quarter <br>Frequency of Submission: Quarterly<br><br>
                                                Link: <a
                                                    href="https://drive.google.com/drive/u/1/folders/1fnC-Jc7qeq7VRdbfh3yvEwW7fLDe3Gcr">bit.ly/POCADAC2022Meetings</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">POPS-PCMS Compliance Report</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">Deadline: End of March <br>Frequency of Submission:
                                                Annual<br><br>
                                                Link: <a
                                                    href="https://intranet.dilg.gov.ph/user/login">intranet.dilg.gov.ph</a>
                                            </h6>
