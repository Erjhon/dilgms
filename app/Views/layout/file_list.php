    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="index.html"> <img src="images/dilg.png"
                        style="align: center; " class="mr-2" alt="logo" /></a><a> Monitoring System<a>
                        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="images/dilg.png"
                                style="align: center;" alt="logo" /> </a>
...
?>
                                    <div>
                                        ...
                                        <embed src="<?= base_url($announcement['filepath']) ?>" type="application/pdf"
                                            width="100%" height="300px">
                                        <?php elseif (endsWith($announcement['filename'], '.doc') || endsWith($announcement['filename'], '.docx')) : ?>
                                        <iframe
                                            src="https://view.officeapps.live.com/op/embed.aspx?src=<?= base_url($announcement['filepath']) ?>"
                                            width="100%" height="600px" frameborder="0">This browser does not support
                                            embedded PDFs. Please download the PDF to view it: <a
                                                href="<?= base_url($file['filepath']) ?>">Download PDF</a></iframe>
                                        <?php else : ?>
                                        <img src="<?= base_url($announcement['filepath']) ?>"
                                            alt="<?= $announcement['filename'] ?>" width="200">
                                        <?php endif; ?>
                                    </div>
                                    <?php 
    $counter++;
