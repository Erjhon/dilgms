                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="user/lgcdd">Local Government Capability
                                        Development Division</a></li>
                                <li class="nav-item"> <a class="nav-link" href="user/lgmed">Local Government Monitoring
                                        and Evaluation Division</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">LGU Energy Code/Energy Virtual One Stop Shop
                                                        (EVOSS) Compliance Monitoring Report</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">Quarterly: Due Every 1st week of the ensuing
                                                month<br>
                                                Access: For Provincial FPs only<br><br>
                                                Link: <a
                                                    href="https://bit.ly/r5EVOSS2023">https://bit.ly/r5EVOSS2023</a><br>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <h6 class="subsub-text">Quarterly: Submit every 1st week of the ensuing
                                                month<br>
                                                Access: For Provincial FPs only<br><br>
                                                Link: <a
                                                    href="https://bit.ly/r5bplsbpco">https://bit.ly/r5bplsbpco</a><br>
                                            </h6>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">Philippine Plan of Action for Nutrition (PPAN)
                                                        Status of Nutrition Programs & Physical Accomplishments</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">*Province/Cities/Municipalities (Semestral)<br>
                                                ...
                                                Access: For Provincial FPs only<br><br>
                                                Link: <a
                                                    href="https://bit.ly/r5PPAN2023">https://bit.ly/r5PPAN2023</a><br>
                                            </h6>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">Persons with Disability Affairs Office (PDAO)
                                                        Monitoring Reports</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">*PDAO Functionality Assessment Form: Not later than
                                                January 30 of every year (hard & soft copies)<br>
                                                *Level of Functionality of PDAO per City/Municipality; Consolidated
                                                Assessment Report (Annex D) hard & soft copy not later than January 30
                                                of every year <br>
                                                *Consolidated Annual Accomplishment Reports submitted not later than the
                                                20th working day of the ensuing year <br>
                                                Access: For Provincial FPs only<br><br>
                                                Link: <a
                                                    href="https://bit.ly/r5PDAO2023">https://bit.ly/r5PDAO2023</a><br>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">RESPONSIBLE PARENTHOOD AND REPRODUCTIVE HEALTH
                                                        (RPRH) Accomplishment Reports</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">*HUC RPRH Report: Every 30th of January and July
                                                <br>
                                                *Provincial/City Implementation Team on RPRH law Annual Unified Work and
                                                Financial Plan: On or before January 15 of every year<br>
                                                *Consolidated Provincial RPRH Law Accomplishment Report: Every 30th of
                                                January and July <br>
                                                Access: For Provincial FPs only<br><br>
                                                Link: <a
                                                    href="https://bit.ly/r5RPRH2023">https://bit.ly/r5RPRH2023</a><br>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">LOCAL REVENUE CODE / LOCAL INVESTMENTS AND
                                                        INCENTIVES CODE (LRC/LIIC)</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">Due 30th day of the last month of the quarter<br>
                                                <br>
                                                Link: <a
                                                    href="https://bit.ly/r5NEO2023">https://bit.ly/r5NEO2023</a><br>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">IMPLEMENTATION OF THE PANTAWID PAMILYANG PILIPINO
                                                        PROGRAM</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">Due every 15th working day of the month of the
                                                succeeding quarter<br>
                                                <br>
                                                Link: <a href="https://bit.ly/3wcuYU">https://bit.ly/3wcuYU</a><br>
                                            </h6>
