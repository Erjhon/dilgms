    ...
    <div class="container-fluid page-body-wrapper">
     ...
     <div class="main-panel">
        ...
        <div class="card2" >
          ...
          <div class="lguadmin">
          <h1>Local Government Policy and Barangay Affairs Section (LGPBAS) </h1>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-3 grid-margin">
                      ...
                      <ul>
                        <li>
                          <h5 style="color: green;">Safety Seal Certification Program Monitoring</a></h5>
                        </li>
                        </ul>
                        
                           <h6 style="margin-left: 15px;">Deadline : 17th day of the current month & 2nd day of the next month  </h6>
                           <h6 style="margin-left: 15px;">Frequency of Submission : Bi-Monthly <br></h6>
                           <p style="margin-left: 15px;">Link: <a href="https://docs.google.com/spreadsheets/d/1LYfOi3NpMuQx5XuvoSzkcj3Rs6YJxqFtAuLx2jaEW7g/edit#gid=0">bit.ly/SSCP_COMonitoring</a></p>
                           <p style="margin-left: 15px;">Link: <a href="https://drive.google.com/drive/u/0/folders/1eGJ6Uq8UxcrnlNLrivqtJImamhco_adh"> bit.ly/SSCPMonitoring</a></p>
                    ...
                    <ul>
                        <li>
                             <h5 style="color: green;">StaySafe.PH Monthly Report</a></h5>
                             <p style="color: green;"> (DILG MC 2021-075)</p>
                        </li>
                    </ul>
