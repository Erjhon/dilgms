                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">Program for Newly-Elected Officials (NEO)
                                                        Consolidated Report</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">Quarterly: Due 28th day of the last month of the
                                                Quarter<br>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <ul>
                                                <li>
                                                    <h5 class="sub2">Local Government Academy Monitoring and Evaluation
                                                        System (LGAMES)</h5>
                                                </li>
                                            </ul>
                                            <h6 class="subsub-text">Quarterly: Due 30th day of the last month of the
                                                ...
                                                Link: <a
                                                    href="https://lgames.lga.gov.ph/">https://lgames.lga.gov.ph/</a><br>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <h6 class="subsub-text">One-time report; can be edited if there are
                                                updates<br>
                                                Access: For LGU OCDMS/CapDev Focal Person; DILG personnel<br><br>
                                                Link: <a
                                                    href="http://ocdms.lga.gov.ph/">http://ocdms.lga.gov.ph/</a><br>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <h6 class="subsub-text">Access: LGU personnel, DILG personnel<br><br>
                                                Link: <a
                                                    href="https://dtp.dilg.gov.ph/">https://dtp.dilg.gov.ph/</a><br>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
